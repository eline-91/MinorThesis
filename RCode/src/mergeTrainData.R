...
# the harmonic metrics, min-max indices and DEM derivatives datasets, and merges 
# them together. The result is written to a csv file.
...
# - location of the min-max indices of the first two years
